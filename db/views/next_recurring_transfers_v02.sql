...
select a.id as rule_id, a.goal_id, a.repeats, CASE WHEN l.last_dt is null THEN a.start_dt WHEN l.last_dt > start_dt THEN l.last_dt ELSE a.start_dt END + (a.repeats || a.frequency)::interval as next_transnfer from all_rules a LEFT JOIN last_dt_table l ON l.rule_id = a.id
